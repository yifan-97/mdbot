    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (result.status === dialog_1.DialogTurnStatus.complete || result.status === dialog_1.DialogTurnStatus.cancelled) {
            if (sendEoCToParent(context)) {
                ...
                const activity = { type: botbuilder_core_1.ActivityTypes.EndOfConversation, value: result.result, locale: context.activity.locale };
 ...
 * @param context
 */
function sendEoCToParent(context) {
