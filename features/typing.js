...
module.exports = function(controller) {
    ...
    let typing = new BotkitConversation('humanTyping', controller);

    typing.addAction('initial', 'default');
    typing.addMessage({type: 'typing'}, 'initial');
    typing.addAction('next_thread','initial');
